...
o1 = sp.getstatusoutput(cmd)
cmd0 = "sudo cp -rf hp.xml /var/www/cgi-bin/core-site.xml"
o2 = sp.getstatusoutput(cmd0)
c1 = "sudo cp -rd hp.xml /var/www/cgi-bin/hdfs-site.xml"
...
cmd5 = 'sudo echo \<name\>dfs.data.dir\<\/name\> >> /var/www/cgi-bin/hdfs-site.xml'
...
cmd25 = "sudo hadoop-daemon.sh start datanode"
